...
<svelte:head>
	...
	<meta property="og:url" content={`${PUBLIC_HOST_URL}/companies/${data.details.id}`} />
...
<section class="container" itemscope itemtype="https://schema.org/Organization">
	<div class="photoNameBio">
		<div class="photoBuffer">
			<figure class="photo">
				<img itemprop="image" src={data.details.photo?.url ?? '/photos/picture.png'} alt={data.details.photo?.url ? data.details.name : 'Placeholder'} width="750px" height="750px" loading="lazy" />
				<SignedIn>
					<a class="button-edit" href={`/companies/${data.details.id}/photo/profile:0`}>
	...
	<div class="detailsFilmography">
		<div class="detailsContainer">
			<div class="band">
				...
				<SignedIn>
					<a href={`/companies/${data.details.id}/edit`} class="button-icon">
						<img 
							src='/add-icon.svg'
							alt='Add icon'
							width="30px"
